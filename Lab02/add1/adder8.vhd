...
begin
    ...
    FA0: fulladd port map(C(0), X(0), Y(0), S(0), C(1));
	 ...
	 FA4: fulladd port map(C(4), X(4), Y(4), S(4), C(5));
	 FA5: fulladd port map(C(5), X(5), Y(5), S(5), C(6));
	 FA6: fulladd port map(C(6), X(6), Y(6), S(6), C(7));
	 FA7: fulladd port map(C(7), X(7), Y(7), S(7), C(8));
